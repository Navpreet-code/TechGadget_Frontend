...
const PrivacyAndPolicy = () => {
  return (
    <>
      <Navbar />
      <section className="py-16 px-6 md:px-20 bg-[#d7dde8] text-gray-800">
        <div className="max-w-5xl mx-auto bg-white shadow-2xl rounded-2xl p-8 md:p-12 leading-relaxed">
          ...
          {/* ✅ Main Privacy Policy Content (from TermsFeed clipboard) */}
          <div
            className="privacy-content text-justify space-y-4"
            dangerouslySetInnerHTML={{
              __html: `
                ...
                <p>The words whose initial letters are capitalized...</p>
...
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Tech Gadgets.</p>
</li>
<li>
...
<li>
<p><strong>Website</strong> refers to Tech Gadgets, accessible from <a href="http://localhost:5173/" rel="external nofollow noopener" target="_blank">http://localhost:5173/</a></p>
</li>
<li>
...
<li>Email: <a href="mailto:navpreetsinghcse@gmail.com">navpreetsinghcse@gmail.com</a></li>
          ...
          <div className="text-center mt-10">
            <a
              href="https://www.termsfeed.com/live/57ddebcb-c0d7-4747-9079-141ac95d2db6"
              target="_blank"
